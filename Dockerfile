...
ARG DRONE_VERSION_TAG=v1.9.1

# HINT: to pick up bug fix commit for v1.9.1, but don't bringing anyother commit
# ref: https://github.com/drone/drone/pull/3027
ARG DRONE_VERSION_CHERRY_PICK=8f32f44f9e01dd5ba505e0ea66a5d87f6aedf71d
